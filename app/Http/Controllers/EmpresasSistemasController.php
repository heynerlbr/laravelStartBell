...
class EmpresasSistemasController extends Controller
{
    public function index()
    {
        return view('empresassistemas.index');
    }
    public function Listar() {
        ...
        try{
            ...
            if ($Tipouser=='admin') {
                # code...
                $empresas =  empresas_sistemas::get();
            }else{
    ...
    public function Eliminar(){
        ...
        try{
            $flight = empresas_sistemas::find($datos->id);
            $flight->delete();
    ...
    public function Crear(){
        ...
        try{         
            $Tipouser = Auth::user()->roles->first()->name;
            $idUser = Auth::user()->id;
            $existe = DB::table('empresas_sistemas')
            ...
            if (count($existe) > 0) {
                ...
                $empresa = empresas_sistemas::create([
                    'nombre' => $datos->nombre, 
                ...
                if ($datos->email !="" && $datos->email !=null ) {
                    ...
                    // EmpresasSistemasController::enviarMailCreacion($datos->email,$datos->identificacion);
                }
                $registro = empresas_sistemas::latest('id')->first();
    ...
    public function Mostrar(){
        ...
        $empresa="";
        try{
            $empresa=empresas_sistemas::find($datos->id);                      
