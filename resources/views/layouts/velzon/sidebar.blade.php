...
<div class="app-menu navbar-menu" style="--vz-vertical-menu-bg: #003f70 !important;">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="dashboard" class="logo logo-dark">
            <span class="logo-sm">
                <img src="{{ URL::asset('storage/Msi-Logo blanco.png') }}" alt="" height="100">
            </span>
            <span class="logo-lg">
                <img src="{{ URL::asset('storage/Msi-Logo blanco.png') }}" alt="" height="100">
            </span>
        ...
        <a href="dashboard" class="logo logo-light">
            <span class="logo-sm">
                <img src="{{ URL::asset('storage/Msi-Logo blanco.png') }}" alt="" height="50">
            </span>
            <span class="logo-lg">
                <img src="{{ URL::asset('storage/Msi-Logo blanco.png') }}" alt="" height="90">
            </span>
        </a>
        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                {{-- <li class="menu-label mt-0">SOFTWARE MANTENIMIENTO </li> --}}
                    ...
                    {{-- <li class="nav-item"><a class="nav-link menu-link" href="dashboard"><i class="fas fa-home"></i>Dashboard</a></li> --}}
                    {{-- <li class="nav-item"><a class="nav-link menu-link" href="hojasvidas"><i class="fas fa-file"></i>Hojas Vida</a></li> --}}
            ...
            {{-- <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarLayouts" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarLayouts">
                        <i class="mdi mdi-view-carousel-outline"></i> <span>@lang('translation.layouts')</span> <span class="badge badge-pill bg-danger">@lang('translation.hot')</span>
                    ...
                    <div class="collapse menu-dropdown" id="sidebarLayouts">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="layouts-vertical-hovered" class="nav-link" target="_blank">@lang('translation.hovered')
                                </a>
                            </li>
                        </ul>
                    </div>
